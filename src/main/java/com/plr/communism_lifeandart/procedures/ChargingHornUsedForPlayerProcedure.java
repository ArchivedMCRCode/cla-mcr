...
public class ChargingHornUsedForPlayerProcedure extends CommunismLifeandartModElements.ModElement {
	public ChargingHornUsedForPlayerProcedure(CommunismLifeandartModElements instance) {
		super(instance, 98);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency entity for procedure ChargingHornUsedForPlayer!");
			return;
		}
