...
public class TinnedSalmonCaviarWhenEatenProcedure extends CommunismLifeandartModElements.ModElement {
	public TinnedSalmonCaviarWhenEatenProcedure(CommunismLifeandartModElements instance) {
		super(instance, 45);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency entity for procedure TinnedSalmonCaviarWhenEaten!");
			return;
		}
