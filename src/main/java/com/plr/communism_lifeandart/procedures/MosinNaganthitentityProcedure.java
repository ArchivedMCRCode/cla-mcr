	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency x for procedure MosinNaganthitentity!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency y for procedure MosinNaganthitentity!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency z for procedure MosinNaganthitentity!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency world for procedure MosinNaganthitentity!");
			return;
		}
