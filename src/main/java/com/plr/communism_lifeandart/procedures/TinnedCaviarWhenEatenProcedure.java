...
public class TinnedCaviarWhenEatenProcedure extends CommunismLifeandartModElements.ModElement {
	public TinnedCaviarWhenEatenProcedure(CommunismLifeandartModElements instance) {
		super(instance, 43);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CommunismLifeandartMod.LOGGER.warn("Failed to load dependency entity for procedure TinnedCaviarWhenEaten!");
			return;
		}
