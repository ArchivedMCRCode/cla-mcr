...
public class SausageMouldItem extends CommunismLifeandartModElements.ModElement {
	@ObjectHolder("communism_lifeandart:sausage_mould")
	public static final Item block = null;
	public SausageMouldItem(CommunismLifeandartModElements instance) {
		super(instance, 30);
	}
