...
import com.plr.communism_lifeandart.procedures.KvassWhenDrunkProcedure;
...
public class KvassItem extends CommunismLifeandartModElements.ModElement {
	@ObjectHolder("communism_lifeandart:kvass")
	public static final Item block = null;
	public KvassItem(CommunismLifeandartModElements instance) {
		super(instance, 25);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				KvassWhenDrunkProcedure.executeProcedure($_dependencies);
			}
