...
public class SoundItem extends CommunismLifeandartModElements.ModElement {
	@ObjectHolder("communism_lifeandart:sound")
	public static final Item block = null;
	public SoundItem(CommunismLifeandartModElements instance) {
		super(instance, 97);
	}
