...
import com.plr.communism_lifeandart.procedures.TinnedSalmonCaviarWhenEatenProcedure;
...
public class TinnedSalmonCaviarItem extends CommunismLifeandartModElements.ModElement {
	@ObjectHolder("communism_lifeandart:tinned_salmon_caviar")
	public static final Item block = null;
	public TinnedSalmonCaviarItem(CommunismLifeandartModElements instance) {
		super(instance, 22);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("tinned_salmon_caviar");
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				TinnedSalmonCaviarWhenEatenProcedure.executeProcedure($_dependencies);
			}
