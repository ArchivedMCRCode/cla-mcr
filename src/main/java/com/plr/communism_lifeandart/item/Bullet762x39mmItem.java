...
public class Bullet762x39mmItem extends CommunismLifeandartModElements.ModElement {
	@ObjectHolder("communism_lifeandart:bullet_762x_39mm")
	public static final Item block = null;
	public Bullet762x39mmItem(CommunismLifeandartModElements instance) {
		super(instance, 21);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bullet_762x_39mm");
		}
