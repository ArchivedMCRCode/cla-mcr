...
import com.plr.communism_lifeandart.entity.BearEntity;
...
public class BearRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BearEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpolarbear(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("communism_lifeandart:textures/polarbear.png");
					}
				};
			});
		}
