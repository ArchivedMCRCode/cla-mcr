...
package com.plr.communism_lifeandart.entity;
...
public class CombineDonEntity extends CommunismLifeandartModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(3f, 1.2f)).build("combine_don").setRegistryName("combine_don");
	public CombineDonEntity(CommunismLifeandartModElements instance) {
		super(instance, 118);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CombineDonRenderer.ModelRegisterHandler());
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.12);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
					.getValue(new ResourceLocation("communism_lifeandart:engine_combine")), 0.15f, 1);
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				CombineWhenclickedProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
