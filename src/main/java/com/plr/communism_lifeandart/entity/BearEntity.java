...
import com.plr.communism_lifeandart.entity.renderer.BearRenderer;
import com.plr.communism_lifeandart.CommunismLifeandartModElements;

@CommunismLifeandartModElements.ModElement.Tag
public class BearEntity extends CommunismLifeandartModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.4f, 1.4f)).build("bear").setRegistryName("bear");
	public BearEntity(CommunismLifeandartModElements instance) {
		super(instance, 18);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BearRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10079488, -6750208, new Item.Properties().group(CommunismLifeAndArtItemGroup.tab))
				.setRegistryName("bear_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 1, 4, 4));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, CapitalistEntity.CustomEntity.class, false, false));
			this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1, (float) 10, (float) 2, false));
			this.goalSelector.addGoal(4, new RandomWalkingGoal(this, 1));
			this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.BEEF, (int) (1)).getItem()), false));
			this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.PORKCHOP, (int) (1)).getItem()), false));
			this.goalSelector.addGoal(7, new OwnerHurtTargetGoal(this));
			this.targetSelector.addGoal(8, new HurtByTargetGoal(this));
			this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, FoxEntity.class, false, false));
			this.goalSelector.addGoal(10, new OpenDoorGoal(this, true));
			this.goalSelector.addGoal(11, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(12, new SwimGoal(this));
			this.goalSelector.addGoal(13, new BreedGoal(this, 1));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			...
			if (new ItemStack(Items.BEEF, (int) (1)).getItem() == stack.getItem())
				return true;
			if (new ItemStack(Blocks.STONE, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
